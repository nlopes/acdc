...
For IDE-quality error messages with context and suggestions, see `acdc-lsp`. The LSP server provides diagnostics, hover information, go-to-definition, and other features that make working with AsciiDoc in editors much nicer.
