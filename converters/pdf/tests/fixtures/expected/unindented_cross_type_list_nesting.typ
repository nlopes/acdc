#set document(
  title: "Unindented cross-type list nesting",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Unindented cross-type list nesting]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Unindented cross-type list nesting")]
]
#v(1em)

#heading(level: 1)[#text("Ordered parent")] <id-5f6f7264657265645f706172656e74>
...
#heading(level: 1)[#text("Alternating levels")] <id-5f616c7465726e6174696e675f6c6576656c73>
...
#heading(level: 1)[#text("Checklist children")] <id-5f636865636b6c6973745f6368696c6472656e>
