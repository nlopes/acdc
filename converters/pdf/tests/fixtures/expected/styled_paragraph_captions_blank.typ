...
#blocktitle[#text(" 1. ")#text("Example paragraph")]
#examplebox[
#text("Example paragraph content.")
]

#blocktitle[#text(" 2. ")#text("Example block")]
#examplebox[
#text("Example block content.")

]

#blocktitle[#text(" 1. ")#text("Listing paragraph")]
#raw(block: true, "listing paragraph")

#blocktitle[#text(" 2. ")#text("Source block")]
