...
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Included references]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Included references")]
]
#v(1em)

#text(size: 1.25em)[#text("Forward: ")#context link(query(<id-696e636c756465642d746172676574>).first().location())[#text("Section 1")]#text(" and ")#context link(query(<id-696e636c756465642d746172676574>).first().location())[#text("Section 1")]#text(". Explicit: ")#context link(query(<id-646f747465642e6964>).first().location())[#text("Custom ")#strong[#text("label")]]#text(". External same ID: ")#link("other.pdf#included-target")[#text("other.pdf")]#text(". Missing local: ")#text("[missing.id]")#text(". URL: ")#link("https://example.org/other.pdf#included-target")[#text("External")]#text(".")]
