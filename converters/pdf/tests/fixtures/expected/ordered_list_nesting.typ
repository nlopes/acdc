#set document(
  title: "Ordered list nesting",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Ordered list nesting]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Ordered list nesting")]
]
#v(1em)

#heading(level: 1)[#text("Automatic styles")] <id-5f6175746f6d617469635f7374796c6573>
...
#heading(level: 1)[#text("Explicit parent")] <id-5f6578706c696369745f706172656e74>
