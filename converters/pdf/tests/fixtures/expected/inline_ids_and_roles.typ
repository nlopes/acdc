#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Inline IDs and roles]], footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Inline IDs and roles")]
]
#v(1em)
...
#text(size: 1.2em)[#text("big")]

#text(size: 0.8em)[#text("small")]

#text(fill: rgb("#606060"))[#text("gray")]

#text(fill: rgb("#bfbfbf"))[#text("white")]
