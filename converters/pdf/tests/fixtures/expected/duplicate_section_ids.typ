...
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Duplicate section IDs]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Duplicate section IDs")]
]
#v(1em)
...
#_acdc_toc_entry(<id-73616d65>, 0, [#text("First")])
#_acdc_toc_entry(<acdc-section-0>, 0, [#text("Second")])
#pagebreak()

#heading(level: 1)[#text("First")] <id-73616d65>

#text("First section content.")

#pagebreak(weak: true)

#heading(level: 1)[#text("Second")] <acdc-section-0>

#text("Second section content. See ")#context link(query(<id-73616d65>).first().location())[#text("First")]#text(".")
