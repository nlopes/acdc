...
#docimage("/images/de454d7e4e1cfda7.svg", width: 30pt)
...
#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 40pt)]

#text("PDF width overrides generic width:")

#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 60pt)]

#text("Generic percentage, capped at the content width:")

#docimage("/images/de454d7e4e1cfda7.svg", ratio: 1)

#text("PDF percentage, allowed to exceed the content width:")

#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 200%)]
...
#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 30pt)]

#text("PDF width accepts physical units:")

#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 72pt)]

#text("PDF width can scale the intrinsic width:")

#block(width: 100%, radius: 4pt, clip: false)[#scale(x: 50%, y: 50%, reflow: true, image("/images/de454d7e4e1cfda7.svg"))]

#text("PDF width can use the page width:")

#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 297.638pt)]

#text("An invalid PDF width still overrides the generic width:")

#block(width: 100%, radius: 4pt, clip: false)[#image("/images/de454d7e4e1cfda7.svg", width: 0pt)]

#heading(level: 1)[#text("Inline images")] <id-5f696e6c696e655f696d61676573>

#text("No local dimensions: before ")#box(image("/images/de454d7e4e1cfda7.svg"))#text(" after.")

#text("Generic positional width: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 30pt))#text(" after.")

#text("Generic named width: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 30pt))#text(" after.")

#text("PDF width: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 40pt))#text(" after.")

#text("PDF width overrides generic width: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 60pt))#text(" after.")

#text("Generic oversized percentage: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 100%))#text(" after.")

#text("PDF oversized percentage: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 100%))#text(" after.")

#text("Generic unit-suffixed width: before ")#box(image("/images/de454d7e4e1cfda7.svg"))#text(" after.")

#text("PDF width in CSS pixels: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 30pt))#text(" after.")

#text("PDF width in inches: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 72pt))#text(" after.")

#text("PDF intrinsic ratio: before ")#box(scale(x: 50%, y: 50%, reflow: true, image("/images/de454d7e4e1cfda7.svg")))#text(" after.")

#text("Inline PDF viewport units fall back to points: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 50pt))#text(" after.")

#text("Invalid PDF width: before ")#box(image("/images/de454d7e4e1cfda7.svg", width: 0pt))#text(" after.")
