#set document(
  title: "Index Terms in Repeated Table Headers for Print",
)
#set page(paper: "a5", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Index Terms in Repeated Table Headers for Print]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Index Terms in Repeated Table Headers for Print")]
]
#v(1em)
...
#v(0.25em)
#par(hanging-indent: 1em)[#text("after table")#_acdc_index_pages((<__indexterm-10>,), "print")]
#v(0.75em)
#text(weight: "bold")[#text("B")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("before table")#_acdc_index_pages((<__indexterm-1>,), "print")]
#par(hanging-indent: 1em)[#text("body term")#_acdc_index_pages((<__indexterm-8>,), "print")]
#v(0.75em)
#text(weight: "bold")[#text("F")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("footer term")#_acdc_index_pages((<__indexterm-9>,), "print")]
#v(0.75em)
#text(weight: "bold")[#text("R")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("Related header")#_acdc_index_pages((<__indexterm-5>,), "print")]
#pad(left: 1 * 1.25em)[#par(hanging-indent: 1em)[(see also #text("Tables"))]]
#v(0.75em)
#text(weight: "bold")[#text("S")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("shared term")#_acdc_index_pages((<__indexterm-4>,<__indexterm-7>,), "print")]
#v(0.75em)
#text(weight: "bold")[#text("T")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("table title")#_acdc_index_pages((<__indexterm-2>,), "print")]
...
#pad(left: 2 * 1.25em)[#par(hanging-indent: 1em)[#text("concealed")#_acdc_index_pages((<__indexterm-3>,), "print")]]
#v(0.75em)
#text(weight: "bold")[#text("V")]
#v(0.25em)
#par(hanging-indent: 1em)[#text("visible ")#strong[#text("header")]#_acdc_index_pages((<__indexterm-6>,), "print")]
]
