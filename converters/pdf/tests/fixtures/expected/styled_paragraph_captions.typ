...
#block(below: 0.5em)[#text(weight: "bold")[#text("Example 1. ")#text("Example paragraph")]]
#examplebox[
...
#block(below: 0.5em)[#text(weight: "bold")[#text("Example 2. ")#text("Example block")]]
#examplebox[
#text("Example block content.")

]

#block(below: 0.5em)[#text(weight: "bold")[#text("Special: ")#text("Custom example paragraph")]]
#examplebox[
#text("Custom example paragraph content.")
]

#block(below: 0.5em)[#text(weight: "bold")[#text("Example 3. ")#text("Example after custom caption")]]
#examplebox[
#text("Example content after the custom caption.")

]

#block(below: 0.5em)[#text(weight: "bold")[#text("Listing 1. ")#text("Listing paragraph")]]
#raw(block: true, "listing paragraph")

#block(below: 0.5em)[#text(weight: "bold")[#text("Listing 2. ")#text("Source paragraph")]]
#raw(block: true, "let paragraph = 1;")

#raw(block: true, "untitled listing paragraph")

#block(below: 0.5em)[#text(weight: "bold")[#text("Listing 3. ")#text("Listing block")]]
#raw(block: true, "listing block")

#block(below: 0.5em)[#text(weight: "bold")[#text("Listing 4. ")#text("Source block")]]
#raw(block: true, "let block = 2;")

#block(below: 0.5em)[#text(weight: "bold")[#text("Snippet: ")#text("Custom listing paragraph")]]
#raw(block: true, "custom listing paragraph")

#block(below: 0.5em)[#text(weight: "bold")[#text("Listing 5. ")#text("Listing after custom caption")]]
