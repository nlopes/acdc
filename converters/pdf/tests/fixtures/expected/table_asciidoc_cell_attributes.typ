#set document(
  title: "AsciiDoc-style table cell attributes",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[AsciiDoc-style table cell attributes]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("AsciiDoc-style table cell attributes")]
]
#v(1em)
...
#text("Before enabling text.")

#heading(level: 1, outlined: false, bookmarked: false)[#text("1. ")#text("After enabling numbers")] <id-5f61667465725f656e61626c696e675f6e756d62657273>

#text("After enabling text.")

#heading(level: 2, outlined: false, bookmarked: false)[#text("Child beyond the numbering depth")] <id-5f6368696c645f6265796f6e645f7468655f6e756d626572696e675f6465707468>
...
#text("Outer content sees {cell-local} and inherited.")
