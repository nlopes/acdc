#set document(
  title: "Link roles and browser attributes",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Link roles and browser attributes]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Link roles and browser attributes")]
]
#v(1em)

#text("Underline URL: ")#underline[#link("https://example.com/underline")[#text("Underlined")]]

#text("Struck link: ")#strike[#link("https://example.com/struck")[#text("Struck")]]

#text("Large link: ")#text(size: 1.2em)[#link("https://example.com/large")[#text("Large")]]

#text("Small mailto: ")#text(size: 0.8em)[#link("mailto:person@example.com")[#text("Small")]]

#text("Combined roles: ")#text(size: 1.2em)[#underline[#link("https://example.com/combined")[#text("Combined")]]]

#text("Unknown role: ")#link("https://example.com/custom")[#text("Custom")]

#text("Button role: ")#link("https://example.com/button")[#text("Button")]

#text("Plain control: ")#link("https://example.com/plain")[#text("Same")]

#text("Window: ")#link("https://example.com/window")[#text("Same")]

#text("Target: ")#link("https://example.com/target")[#text("Same")]

#text("Title: ")#link("https://example.com/title")[#text("Same")]

#text("Nofollow: ")#link("https://example.com/nofollow")[#text("Same")]

#text("Noopener: ")#link("https://example.com/noopener")[#text("Same")]

#text("Relation: ")#link("https://example.com/relation")[#text("Same")]

#text("Window shorthand: ")#link("https://example.com/shorthand")[#text("Same")]
