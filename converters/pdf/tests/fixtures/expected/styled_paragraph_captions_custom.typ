...
#blocktitle[#text("Sample 1. ")#text("Example paragraph")]
#examplebox[
#text("Example paragraph content.")
]

#blocktitle[#text("Sample 2. ")#text("Example block")]
#examplebox[
#text("Example block content.")

]

#blocktitle[#text("Code 1. ")#text("Listing paragraph")]
#raw(block: true, "listing paragraph")

#blocktitle[#text("Code 2. ")#text("Source block")]
