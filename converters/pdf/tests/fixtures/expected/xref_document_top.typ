...
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Main: Subtitle]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Main")]
#v(0.2em)
#text(size: 14pt, weight: "bold", style: "italic")[#text("Subtitle")]
]
#v(1em)

#text(size: 1.25em)[#text("Top: ")#link((page: 1, x: 0pt, y: 0pt))[#text("[^top]")]#text(" and ")#link((page: 1, x: 0pt, y: 0pt))[#text("[^top]")]#text(". Explicit: ")#link((page: 1, x: 0pt, y: 0pt))[#text("Start")]#text(".")]
