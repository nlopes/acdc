...
#text("The workflow refers back to ")#context link(query(<id-7265666572656e63652d7461626c65>).first().location())[#text("Table 1")#text(", “")#text("Repeated inventory")#text("”")]#text(" and repeats the named footnote.")#footnote(<id-666f6f746e6f74653a736861726564>)
...
#text("The final section links back to ")#context link(query(<id-6f76657276696577>).first().location())[#text("Overview")]#text(", ")#context link(query(<id-666978747572652d696d616765>).first().location())[#text("Figure 1")#text(", “")#text("Fixture image")#text("”")]#text(", and ")#context link(query(<id-776f726b666c6f772d6578616d706c65>).first().location())[#text("Example 1")#text(", “")#text("Expected result")#text("”")]#text(". It also keeps a ")#link("https://example.com/final")[#text("second external link")]#text(" in the generated PDF.")
