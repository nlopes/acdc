...
#text(size: 1.25em)[#text("See ")#context link(query(<id-73656374696f6e2d6964>).first().location())[#text("Section Title")]#text(", ")#context link(query(<id-7061726167726170682d6964>).first().location())[#text("Paragraph Title")]#text(", ")#context link(query(<id-6c697374696e672d6964>).first().location())[#text("Listing Title")]#text(", ")#context link(query(<id-6c69746572616c2d6964>).first().location())[#text("Literal Title")]#text(", ")#context link(query(<id-736f757263652d6964>).first().location())[#text("Source Title")]#text(", ")#context link(query(<id-6578616d706c652d6964>).first().location())[#text("Example Title")]#text(", ")#context link(query(<id-6f70656e2d6964>).first().location())[#text("Open Title")]#text(", ")#context link(query(<id-736964656261722d6964>).first().location())[#text("Sidebar Title")]#text(", ")#context link(query(<id-71756f74652d6964>).first().location())[#text("Quote Title")]#text(", ")#context link(query(<id-76657273652d6964>).first().location())[#text("Verse Title")]#text(", ")#context link(query(<id-706173737468726f7567682d6964>).first().location())[#text("Passthrough Title")]#text(", ")#context link(query(<id-7374656d2d6964>).first().location())[#text("Stem Title")]#text(", ")#context link(query(<id-7461626c652d6964>).first().location())[#text("Table ")#strong[#text("Title")]]#text(", ")#context link(query(<id-6f7264657265642d6964>).first().location())[#text("Ordered List Title")]#text(", ")#context link(query(<id-756e6f7264657265642d6964>).first().location())[#text("Unordered List Title")]#text(", ")#context link(query(<id-6465736372697074696f6e2d6964>).first().location())[#text("Description List Title")]#text(", ")#context link(query(<id-63616c6c6f75742d6964>).first().location())[#text("Callout List Title")]#text(", ")#context link(query(<id-61646d6f6e6974696f6e2d6964>).first().location())[#text("Admonition ")#strong[#text("Title")]]#text(", ")#context link(query(<id-696d6167652d6964>).first().location())[#text("Image Title")]#text(", ")#context link(query(<id-766964656f2d6964>).first().location())[#text("Video Title")]#text(", ")#context link(query(<id-617564696f2d6964>).first().location())[#text("Audio Title")]#text(", ")#context link(query(<id-7468656d617469632d6964>).first().location())[#text("Thematic Title")]#text(", ")#context link(query(<id-706167652d6964>).first().location())[#text("Page Title")]#text(", and ")#context link(query(<id-64697363726574652d6964>).first().location())[#text("Discrete Title")]#text(".")]

#text("See also ")#context link(query(<id-637573746f6d2d6c697374696e672d6964>).first().location())[#text("Custom Listing")]#text(" and ")#context link(query(<id-7465726d2d6964>).first().location())[#text("[term-id]")]#text(".")
