...
#text("See ")#context link(query(<id-6e6f726d616c2d7269676874>).first().location())[#text("Normal ")#strong[#text("right")]#text(" title")]#text(", ")#context link(query(<id-6e6f726d616c2d63656e746572>).first().location())[#text("Normal ")#strong[#text("center")]#text(" title")]#text(", ")#context link(query(<id-6e6f726d616c2d6a757374696679>).first().location())[#text("Normal ")#strong[#text("justified")]#text(" title")]#text(", ")#context link(query(<id-6e6f726d616c2d6c656674>).first().location())[#text("Normal ")#strong[#text("left")]#text(" title")]#text(", ")#context link(query(<id-71756f7465>).first().location())[#text("Quote ")#strong[#text("title")]]#text(", ")#context link(query(<id-7665727365>).first().location())[#text("Verse ")#strong[#text("title")]]#text(", ")#context link(query(<id-6c69746572616c>).first().location())[#text("Literal ")#strong[#text("title")]]#text(", ")#context link(query(<id-6c697374696e67>).first().location())[#text("Listing ")#strong[#text("title")]]#text(", ")#context link(query(<id-736f75726365>).first().location())[#text("Source ")#strong[#text("title")]]#text(", ")#context link(query(<id-6578616d706c65>).first().location())[#text("Example ")#strong[#text("title")]]#text(", and ")#context link(query(<id-6162737472616374>).first().location())[#text("Abstract ")#strong[#text("title")]]#text(".")
