#set document(
  title: "Article Special Section Numbering",
)
...
#_acdc_toc_entry(<id-5f66697273745f73656374696f6e>, 0, [#text("1. ")#text("First Section")])
#_acdc_toc_entry(<id-5f66697273745f746f706963>, 1, [#text("1.1. ")#text("First Topic")])
...
#_acdc_toc_entry(<id-5f7365636f6e645f73656374696f6e>, 0, [#text("2. ")#text("Second Section")])
