#set document(
  title: "Book TOC Numbering",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Book TOC Numbering]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#v(30%)
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Book TOC Numbering")]
]
...
#_acdc_toc_entry(<id-5f666f756e646174696f6e73>, 0, [#text("I: ")#text("Foundations")])
#_acdc_toc_entry(<id-5f66697273745f63686170746572>, 1, [#text("1. ")#text("First Chapter")])
#_acdc_toc_entry(<id-5f66697273745f746f706963>, 2, [#text("1.1. ")#text("First Topic")])
#_acdc_toc_entry(<id-5f6170706c69636174696f6e73>, 0, [#text("II: ")#text("Applications")])
#_acdc_toc_entry(<id-5f7365636f6e645f63686170746572>, 1, [#text("2. ")#text("Second Chapter")])
#_acdc_toc_entry(<id-5f7365636f6e645f746f706963>, 2, [#text("2.1. ")#text("Second Topic")])
#pagebreak()
...
#heading(level: 1)[#text("Unit 1. ")#text("First Chapter")] <id-5f66697273745f63686170746572>

#heading(level: 2)[#text("1.1. ")#text("First Topic")] <id-5f66697273745f746f706963>

#text("First chapter body.")

#pagebreak(weak: true)

#heading(level: 1)[#text("Volume II: ")#text("Applications")] <id-5f6170706c69636174696f6e73>

#pagebreak(weak: true)

#heading(level: 1)[#text("Unit 2. ")#text("Second Chapter")] <id-5f7365636f6e645f63686170746572>
