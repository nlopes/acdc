#set document(
  title: "Styled image macro contexts",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Styled image macro contexts]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Styled image macro contexts")]
]
#v(1em)

#blocktitle[#text("Listing 1. ")#text("Listing style")]
#raw(block: true, "image::listing.png[Listing alt]")

#blocktitle[#text("Listing 2. ")#text("Source style")]
#raw(block: true, "image::source.png[Source alt]")

#blocktitle[#text("Literal style")]
#raw(block: true, "image::literal.png[Literal alt]")
...
#raw(block: true, "image::untitled-listing.png[Untitled listing alt]")
