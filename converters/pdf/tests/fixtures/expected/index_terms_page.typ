#set document(
  title: "Index page sequence",
)
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm), fill: rgb("#ffffff"), header: context if counter(page).get().first() > 1 { align(left + horizon)[#text(fill: rgb("#374151"), weight: 500, size: 11pt)[Index page sequence]] }, footer: text(fill: rgb("#9ca3af"), size: 9pt)[#grid(columns: (1fr, 1fr, 1fr), align(left)[], align(center)[#context counter(page).display()], align(right)[])])
...
#align(center)[
#text(size: 22pt, weight: "bold")[#text("Index page sequence")]
]
#v(1em)
...
#v(0.25em)
#par(hanging-indent: 1em)[#text("term")#_acdc_index_pages((<__indexterm-1>,<__indexterm-2>,), "page")]
]
