...
- **Block destinations**: section and discrete-heading IDs, explicit `[#id]`
  block IDs, and `[[id]]` block anchors render as portable HTML anchors in
  both variants, so local cross-references have stable destinations.
