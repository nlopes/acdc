...
image:https://github.com/nlopes/acdc/workflows/Test/badge.svg[alt="CI status",link=https://github.com/nlopes/acdc/actions] image:https://docs.rs/acdc-parser/badge.svg[alt="docs.rs",link=https://docs.rs/acdc-parser] image:https://img.shields.io/crates/v/acdc-parser.svg[alt="crates.io",link=https://crates.io/crates/acdc-parser] image:https://img.shields.io/badge/license-MIT-blue.svg[alt="MIT licensed",link=https://github.com/nlopes/acdc/blob/main/LICENSE]
...
* link:./acdc-lint[acdc-lint] - lint command support for AsciiDoc recommended-practice checks
* link:./acdc-lsp[acdc-lsp] - Language Server Protocol implementation
* link:./acdc-parser[acdc-parser] - AsciiDoc parser library
* link:./converters[converters] - collection of AsciiDoc converters (HTML, manpage, markdown, PDF, terminal)
* link:./converters/dev[acdc-converters-dev] - internal dev-only converter utilities (unpublished)
...
Fail-fast:: Stops on the first error by design.
Preprocessor:: Handles includes and conditionals before parsing.

=== Testing strategy

. Fixture tests compare against known good outputs.
. Property tests verify invariants for generated input.
. TCK tests check specification compliance.
. Integration tests exercise end-to-end conversion.

== Building & testing

Before running all-features checks, install the development prerequisites in link:./CONTRIBUTING.md[CONTRIBUTING.md].
